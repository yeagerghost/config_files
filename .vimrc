...
function InvJournal()
  ...
  :s/START/GETINVSEATS/
  /END
  :s/END/END-INVSEATS-GET/
  /START
  :s/START/SINVSEATS/
  /END
  :s/END/END-SEATS-SINV/
  /START
  :s/START/GENOPENS/
  /END
  :s/END/END-GENOPENS/
...
function GetInvseats()
  :/GETINVSEATS/+1,/END-INVSEATS-GET/-1s/^.*prodcode='//g
  :/GETINVSEATS/+1,/END-INVSEATS-GET/-1s/'.*$//g
  :/GETINVSEATS/+1,/END-INVSEATS-GET/-2s/\n/ /g
  :/GETINVSEATS/+1,/END-INVSEATS-GET/-1s/^/for arg in /g 
  :/GETINVSEATS/+1,/END-INVSEATS-GET/-1s/$/; do invseats.py inv -fcsv $arg > $arg.seats; done
endfunction
...
function SInvseats()
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/).*$/)/g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/\(prodcode=.*' *and\)\(.*$\)/\2 \1/g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/'//g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/ *and$//g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/^.*select.*in/grep -Ew
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/(/'/g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/)/'/g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/, /|/g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/prodcode=//g
  :/SINVSEATS/+1,/END-SEATS-SINV/-1s/$/.seats/g
endfunction
